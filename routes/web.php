...
use App\Http\Controllers\CertificateController;      // ✅ tambah

use App\Http\Controllers\Admin\CategoryController    as AdminCategoryController;
use App\Http\Controllers\Admin\UserController        as AdminUserController;
use App\Http\Controllers\Admin\OrderController       as AdminOrderController;
use App\Http\Controllers\Admin\CourseController      as AdminCourseController;
use App\Http\Controllers\Admin\ScheduleController    as AdminScheduleController;  // ✅ tambah
use App\Http\Controllers\Admin\CompanionController   as AdminCompanionController; // ✅ tambah
use App\Http\Controllers\Admin\BookingController     as AdminBookingController;   // ✅ tambah

use App\Http\Controllers\Instructor\CourseController   as InstructorCourseController;
use App\Http\Controllers\Instructor\SectionController  as InstructorSectionController;  // ✅ tambah
use App\Http\Controllers\Instructor\LectureController  as InstructorLectureController;  // ✅ tambah
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/learn/{course:slug}/quiz/{quiz}',
        [\App\Http\Controllers\Student\QuizController::class, 'show'])->name('quiz.show');
    Route::post('/learn/{course:slug}/quiz/{quiz}/start',
        [\App\Http\Controllers\Student\QuizController::class, 'start'])->name('quiz.start');
    Route::post('/learn/{course:slug}/quiz/{quiz}/submit',
        [\App\Http\Controllers\Student\QuizController::class, 'submit'])->name('quiz.submit');
    Route::get('/learn/{course:slug}/quiz/{quiz}/result',
        [\App\Http\Controllers\Student\QuizController::class, 'result'])->name('quiz.result');
            ...
            return Inertia::render('companion/Dashboard', [
                'stats' => [
                    ...
                    'upcomingBookings' => \App\Models\Booking::where('tutor_id', $user->id)
                        ...
                        ->count(),
                    'totalRevenue'     => \App\Models\Order::where('status', 'paid')
                        ->whereHasMorph('orderable', [\App\Models\Booking::class],
