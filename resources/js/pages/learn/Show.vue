...
<template>
    ...
    <div class="flex h-screen flex-col overflow-hidden bg-gray-950 text-white">
        <!-- TOP BAR -->
        <header
            class="flex shrink-0 items-center justify-between border-b border-gray-800 bg-gray-900 px-4 py-3"
        >
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span
                        class="hidden max-w-xs truncate text-sm font-medium md:block"
                    >
                        {{ course.title }}
                    </span>
                </div>
            ...
            <div class="flex items-center gap-4">
                <div class="hidden items-center gap-2 text-sm md:flex">
                    ...
                    <div
                        class="h-2 w-32 overflow-hidden rounded-full bg-gray-700"
                    >
                        <div
            ...
            >
                ...
                <div>
                    <div v-for="section in course.sections" :key="section.id">
                        ...
                        >
                            <span
                                class="text-sm leading-tight font-medium text-gray-200"
                            >
                                {{ section.title }}
                            </span>
                            <svg
                                ...
                                :class="{
                                    'rotate-180': expandedSections.includes(
                                        section.id,
                                    ),
                                }"
                                fill="none"
                        ...
                        <div v-show="expandedSections.includes(section.id)">
                            ...
                            >
                                <div class="mt-0.5 shrink-0">
                                    ...
                                    <div
                                        v-else
                                        class="h-5 w-5 rounded-full border-2 border-gray-600"
                                    />
                                </div>
                            ...
                            >
                                <div
                                    class="flex h-5 w-5 shrink-0 items-center justify-center rounded bg-amber-500/20"
                                >
                                    <svg
