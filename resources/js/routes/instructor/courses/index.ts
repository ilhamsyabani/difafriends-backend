...
/**
* @see \App\Http\Controllers\Instructor\CourseController::index
* @see app/Http/Controllers/Instructor/CourseController.php:20
...
/**
* @see \App\Http\Controllers\Instructor\CourseController::create
* @see app/Http/Controllers/Instructor/CourseController.php:88
...
/**
* @see \App\Http\Controllers\Instructor\CourseController::store
* @see app/Http/Controllers/Instructor/CourseController.php:102
* @route '/instructor/courses'
*/
...
/**
* @see \App\Http\Controllers\Instructor\CourseController::show
* @see app/Http/Controllers/Instructor/CourseController.php:135
...
/**
* @see \App\Http\Controllers\Instructor\CourseController::edit
* @see app/Http/Controllers/Instructor/CourseController.php:143
...
/**
* @see \App\Http\Controllers\Instructor\CourseController::update
* @see app/Http/Controllers/Instructor/CourseController.php:159
* @route '/instructor/courses/{course}'
*/
...
/**
* @see \App\Http\Controllers\Instructor\CourseController::destroy
* @see app/Http/Controllers/Instructor/CourseController.php:195
* @route '/instructor/courses/{course}'
*/
...
manage.definition = {
    methods: ["get","head"],
    url: '/instructor/courses/{course}/manage',
} satisfies RouteDefinition<["get","head"]>
