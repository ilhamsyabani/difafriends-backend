...
* @route '/livewire-127adb52/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-127adb52/upload-file',
...
* @route '/livewire-127adb52/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-127adb52/preview-file/{filename}',
