...
* @see app/Http/Controllers/Admin/CategoryController.php:55
* @route '/admin/categories'
*/
...
* @see app/Http/Controllers/Admin/CategoryController.php:100
* @route '/admin/categories/{category}'
*/
...
* @see app/Http/Controllers/Admin/CategoryController.php:119
* @route '/admin/categories/{category}'
*/
