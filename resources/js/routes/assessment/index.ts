...
/**
* @see \App\Http\Controllers\AssessmentController::results
* @see app/Http/Controllers/AssessmentController.php:69
* @route '/assessments/results'
*/
export const results = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/assessments/results'
*/
results.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: results.url(options),
    method: 'post',
})
...
* @route '/assessments/results'
*/
const resultsForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/assessments/results'
*/
resultsForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: results.url(options),
    method: 'post',
})
...
const assessment = {
    ...
    kesiapan: Object.assign(kesiapan, kesiapan),
    pemilihan: Object.assign(pemilihan, pemilihan),
