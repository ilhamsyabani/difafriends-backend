...
* @route '/livewire-127adb52/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-127adb52/livewire.js',
...
* @route '/livewire-127adb52/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-127adb52/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-127adb52/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-127adb52/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
