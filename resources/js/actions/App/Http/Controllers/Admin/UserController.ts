...
* @see app/Http/Controllers/Admin/UserController.php:129
...
const UserController = { template, importMethod, index, create, store, show, edit, update, destroy, import: importMethod }
